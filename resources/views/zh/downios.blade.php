...
<body style="padding-left: 54px; padding-right: 54px;" class=" pace-done">
    <div class="container m-container e-hugeDownIosBox" id="e-hugeDownIosBox">
        ...
        <div class="headerBox">
            ...
            <button class="downloadIosBtn mView" onclick="location.href='http://fir.im/InWeCrypto'">下载</button>
        </div>
        <div class="downloadBox" id="downloadBox">
            ...
            <div class="mobileDownload">
                ...
                <p class="mmess2">
                    使用苹果手机自带的 Safari 浏览器打开安装链接，
                    <br/> 点击安装到手机上。 （注：若微信内无法打开下载
                    <br/> 链接，请复制下载网址到浏览器打开，进行安装步骤）
                </p>
            </div>
        </div>
        <div class="pcDownloadBox">
            ...
            <div class="pcDownload">
                ...
                <p class="mess2">
                    新下载APP的用户会出现提示框“未受信任的企业级
                    <br/> 开发者”。此时需要打开：手机自带的设置 ->
                    <br/> 通用 -> 设备管理 -> 选择应用 -> 点击信任。
                </p>
            </div>
            <div class="pcImg">
